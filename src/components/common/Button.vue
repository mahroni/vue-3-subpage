  ...
  cva("font-bold transition-all duration-200 ease-out transform", {
    ...
    compoundVariants: [
      // Disabled states
      {
        intent: "primary",
        disabled: true,
        class: "!bg-gray-300 !text-gray-500 !border-none !shadow-none hover:!bg-gray-300 hover:!text-gray-500",
      },
      {
        intent: "secondary",
        disabled: true,
        class: "!text-gray-400 !border-gray-300 !shadow-none hover:!text-gray-400 hover:!border-gray-300",
      },
      {
        intent: "danger",
        disabled: true,
        class: "!text-red-300 !border-red-300 !shadow-none hover:!text-red-300 hover:!border-red-300",
      },
      {
        intent: "flat",
        disabled: true,
