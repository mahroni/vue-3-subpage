...
<template>
  <div :style="{ backgroundColor: props.color, borderRadius: `${props.rounded}px` }"
    ...
    <span v-if="props.title && props.isUsingTitle"
      class="text-surface-primary-white text-base font-semibold break-words">{{ props.title }}</span>
