  ...
  <div class="flex flex-col gap-8">
    ...
    <Banner intent="positive">
      <div class="flex flex-col gap-[20px] text-sm">
        ...
        <div>
          To set the office hour, please go to the settings menu in the <strong
            >General - Office Hour section.</strong
          >
        </div>
      </div>
    </Banner>
    ...
    <div class="flex flex-col gap-6 rounded-lg bg-white p-6 shadow-[0px_4px_12px_0px_#0A0A0A1A]">
      ...
      <Banner intent="positive">
        <div class="text-sm">
          Note: If you activate this autoresponder then the autoresponder setting on the <strong
            >Settings - General page</strong
          > will not be active.
        </div>
      </Banner>
