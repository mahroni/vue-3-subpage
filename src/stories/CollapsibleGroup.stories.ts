...
const defaultFaqItems = ref([
  {
    ...
    content: '<p class="text-gray-700">Our refund policy allows returns within 30 days of purchase. Please see our full terms for more details. For digital products, refunds are only available if the product is proven to be defective or not as described.</p>',
    initiallyOpen: true, // This item will be open by default
  },
  {
    id: 'faq-2',
    title: 'How do I contact support?',
    content: '<p class="text-gray-700">You can contact our support team via email at <a href="mailto:support@example.com" class="text-blue-600 hover:underline">support@example.com</a> or by calling <strong>1-800-555-1234</strong> during business hours (9 AM - 5 PM WIB, Monday to Friday).</p>',
  },
  {
    id: 'faq-3',
    title: 'Can I change my password?',
    content: '<p class="text-gray-700">Yes, you can change your password from your account settings page. Look for the "Security" or "Password" section.</p>',
  },
  {
    id: 'faq-4',
    title: 'Do you offer international shipping?',
    content: '<p class="text-gray-700">Currently, we only ship within Indonesia. We are working on expanding our shipping options in the near future!</p>',
  },
]);
    ...
    items: [
      {
        ...
        content: '<p class="text-gray-700">Sometimes you just need one collapsible item. Here it is!</p>',
        initiallyOpen: true,
      },
    ],
  },
