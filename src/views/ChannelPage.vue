  ...
  <div class="min-h-screen flex flex-col px-12 py-8 text-text-title text-sm gap-8">
    <div>
      ...
      <p class="text-text-subtitle">
        Choose your first channel to connect with by click a channel icon below
        to start connecting with your customers. To learn more regarding Qiscus
        Omnichannel Chat integration and tutorial, you can watch tutorial video
        demo in
    ...
    <div class="grid grid-cols-3 gap-8">
      <template v-for="channel in filteredChannels" :key="channel.id">
        <div
          ...
          @click.prevent="onSelectChannel(channel)" :class="channel.id">
