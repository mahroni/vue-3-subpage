<template>
    <div class="flex flex-col gap-4 w-full border-[1px] border-gray-300 rounded-2xl bg-white-100">
...
import { ref } from 'vue';
import LiveChatBuilder from '../features/live-chat-builder/index.vue';
